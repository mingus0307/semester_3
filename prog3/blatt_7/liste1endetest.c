...
int test(void) {
    ...
    durchlaufen(kopf);  // Sollte 5 6 ausgeben
    ...
    durchlaufen(kopf);  // Sollte 4 5 6 ausgeben
    printf("*ende=%d\n", ende->wert);
    ...
    durchlaufen(kopf);   // Sollte 4 5 6 7 ausgeben
    printf("*ende=%d\n", ende->wert);
    ...
    durchlaufen(kopf);   // Sollte 4 6 7 ausgeben 
    printf("*ende=%d\n", ende->wert);
    ...
    durchlaufen(kopf);    // Sollte 4 6 ausgeben 
    printf("*ende=%d\n", ende->wert);
    ...
    durchlaufen(kopf);   // Sollte 6 ausgeben 
    printf("*ende=%d\n", ende->wert);
    ...
    durchlaufen(kopf);  // Sollte nichts ausgeben 
